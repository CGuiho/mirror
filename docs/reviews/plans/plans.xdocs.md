...
files: {}
documents:
  guiho-convention-0001-cli-migration-review.md: Digest-bound final independent review returns ready for execution with explicit prerequisites and no technical findings; no unit is executable until human and base gates close.
